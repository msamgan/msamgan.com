    ...
    <div class="container mx-auto">
        <div class="flex flex-col items-center justify-between gap-3 lg:flex-row">
            ...
            <div>
                ...
                <p class="text-md mb-4 mt-3 font-light leading-7 text-gray-700 dark:text-white">
                    I created Framework X to be all about substance over style!. A well-oiled machine for API
                    development. Please check it out. All and Any feedback is appreciated.
                </p>
                <a
                    href="https://frameworkx.info/docs/introduction"
                    rel="noreferrer noopener"
                    target="_blank"
                    class="float-end hover:text-red-700 dark:font-bold"
