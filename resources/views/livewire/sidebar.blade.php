...
<div>
    ...
    <div class="mb-6 flex items-center">
        <div class="h-10 w-10 rounded-full bg-gray-800 dark:bg-gray-700 flex items-center justify-center">
            <span class="text-white font-medium text-sm">MS</span>
        </div>
        <div class="ml-3">
            <h1 class="text-base font-medium text-gray-900 dark:text-white">Mohammad Samgan</h1>
