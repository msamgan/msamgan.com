...
<div class="sticky left-0 right-0 top-6">
    ...
    {{--
        ...
        id="theme-toggle"
        type="button"
        class="ml-8 items-center justify-center rounded-lg text-sm text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-700"
        >
        <svg
